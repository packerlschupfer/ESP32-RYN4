...
- **Registers**: 0x0001-0x0008 for channels, 0x0000 for broadcast (ALL_ON/ALL_OFF)

### Critical Protocol Asymmetry
**Command values (write) differ from status values (read):**
- Write ON command: 0x0100 → Read back ON status: 0x0001
- Write OFF command: 0x0200 → Read back OFF status: 0x0000
