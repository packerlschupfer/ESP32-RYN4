...
|---------|--------|---------|
| **ON/OFF** | ✅ PASS | Baseline functionality confirmed |
...
std::array<RYN4::RelayCommandSpec, 8> staggered = {
    {RelayAction::ON, 0},     // Motor 1: Immediate
